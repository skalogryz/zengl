// Этот пример строго запрещено использовать как практическое руководство по использованию партиклов :)
program demo11;
...
procedure Init;
  var
    i, j : Integer;
begin
  texBack := tex_LoadFromFile( '../res/back02.png', $FF000000, TEX_DEFAULT_2D );

  fntMain := font_LoadFromFile( '../res/font.zfi' );

  texParticle := tex_LoadFromFile( '../res/particle.png', $FF000000, TEX_DEFAULT_2D or TEX_MIPMAP );
