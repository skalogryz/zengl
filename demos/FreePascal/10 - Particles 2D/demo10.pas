// RU: Этот пример строго запрещено использовать как практическое руководство по использованию партиклов :)
// Причина - вся сцена чистый "хардкод", который в будущем должен будет быть заменен загрузкой из файла
//
