...
void Draw()
{
  ...
  text_Draw( fnt, 0, 0, "Escape - Exit", 0 );
  text_Draw( fnt, 0, 20, "Alt+Enter - FullScreen/Windowed mode", 0 );
  text_Draw( fnt, 0, 40, "Left mouse button - lock mouse :)", 0 );
  ...
  w = text_GetWidth( fnt, something, 0 );
  ...
  char text[256];
  sprintf( text, "Axis X: %1.2f", joy_AxisPos( 0, JOY_AXIS_X ) );
  text_Draw( fnt, 100, 400, text, 0 );
  sprintf( text, "Axis Y: %1.2f", joy_AxisPos( 0, JOY_AXIS_Y ) );
  text_Draw( fnt, 100, 420, text, 0 );
  sprintf( text, "Axis Z: %1.2f", joy_AxisPos( 0, JOY_AXIS_Z ) );
  text_Draw( fnt, 100, 440, text, 0 );
  sprintf( text, "Axis R: %1.2f", joy_AxisPos( 0, JOY_AXIS_R ) );
  text_Draw( fnt, 100, 460, text, 0 );
  sprintf( text, "Axis U: %1.2f", joy_AxisPos( 0, JOY_AXIS_U ) );
  text_Draw( fnt, 100, 480, text, 0 );
  sprintf( text, "Axis V: %1.2f", joy_AxisPos( 0, JOY_AXIS_V ) );
  text_Draw( fnt, 100, 500, text, 0 );
  sprintf( text, "POVX: %1.2f", joy_AxisPos( 0, JOY_POVX ) );
  text_Draw( fnt, 100, 520, text, 0 );
  sprintf( text, "POVY: %1.2f", joy_AxisPos( 0, JOY_POVY ) );
  text_Draw( fnt, 100, 540, text, 0 );

  sprintf( text, "Button1: %s", joy_Down( 0, 0 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 400, 400, text, 0 );
  sprintf( text, "Button2: %s", joy_Down( 0, 1 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 400, 420, text, 0 );
  sprintf( text, "Button3: %s", joy_Down( 0, 2 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 400, 440, text, 0 );
  sprintf( text, "Button4: %s", joy_Down( 0, 3 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 400, 460, text, 0 );
  sprintf( text, "Button5: %s", joy_Down( 0, 4 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 400, 480, text, 0 );
  sprintf( text, "Button6: %s", joy_Down( 0, 5 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 400, 500, text, 0 );
  sprintf( text, "Button7: %s", joy_Down( 0, 6 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 400, 520, text, 0 );
  sprintf( text, "Button8: %s", joy_Down( 0, 7 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 400, 540, text, 0 );
  sprintf( text, "Button9: %s", joy_Down( 0, 8 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 550, 400, text, 0 );
  sprintf( text, "Button10: %s", joy_Down( 0, 9 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 550, 420, text, 0 );
  sprintf( text, "Button11: %s", joy_Down( 0, 10 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 550, 440, text, 0 );
  sprintf( text, "Button12: %s", joy_Down( 0, 11 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 550, 460, text, 0 );
  sprintf( text, "Button13: %s", joy_Down( 0, 12 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 550, 480, text, 0 );
  sprintf( text, "Button14: %s", joy_Down( 0, 13 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 550, 500, text, 0 );
  sprintf( text, "Button15: %s", joy_Down( 0, 14 ) ? "TRUE" : "FALSE" );
  text_Draw( fnt, 550, 520, text, 0 );
  sprintf( text, "Button16: %s", joy_Down( 0, 15 ) ? "TRUE" : "FALSE" );
