// RU: Если вы компилируете для 64-битной ОС и испльзуете FreePascal 2.4.2 или ниже, то этот пример не будет работать корректно.
// Пожалуйста, обновитесь до FreePascal 2.5.1 из svn.
//
...
// EN: Define below will enable static compilation with Chipmunk. Also it must be defined in zglChipmunk.pas.
{$IFDEF FPC}
...
begin
  ...
  text_Draw( fnt, 10, 5,  'FPS: ' + u_IntToStr( zgl_Get( RENDER_FPS ) ) );
  text_Draw( fnt, 10, 25, 'Use your mouse: Left Click - box, Right Click - ball' );
  batch2d_End();
end;
